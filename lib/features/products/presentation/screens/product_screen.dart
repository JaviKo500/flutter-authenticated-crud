      ...
      child: Column(
        ...
        children: [
          ...
          CustomProductField( 
            ...
            onChanged:( value ) =>  ref.read( productFormProvider( product ).notifier ).onPriceChange( double.tryParse(value) ?? 0 ),
          ...
          CustomProductField( 
            ...
            onChanged: (value) => ref.read( productFormProvider( product ).notifier ).onStockChange( int.tryParse(value) ?? 0 ),
    ...
    return PageView(
      ...
      children: images.isEmpty
        ...
        : images.map((e){
          return ClipRRect(
            borderRadius: const BorderRadius.all(Radius.circular(20)),
            child: Image.network(e, fit: BoxFit.cover, errorBuilder: (context, error, stackTrace) => Image.asset('assets/images/no-image.jpg', fit: BoxFit.cover, height: 250,)),
          );
      }).toList(),
    );
  }
